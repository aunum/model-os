...
def get_codes_for_cls(cls: Type) -> List[str]:
    ...
    for name, fn in fns:
        if _get_class_that_defined_method(fn) != cls:
            continue
...
def extracted_file_name(cls) -> str:
    ...
    if hasattr(cls, "short_name"):
        name = cls.short_name()
    return f"{name.lower()}.obj.py"


def extract_cls_to_file(cls: Type) -> str:
    ...
    Returns:
        str: Filepath of the extracted class
    """
    ret_code = "# This file was generated by ModelOS\n"
